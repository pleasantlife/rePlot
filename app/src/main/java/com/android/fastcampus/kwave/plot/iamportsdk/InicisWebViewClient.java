package com.android.fastcampus.kwave.plot.iamportsdk;
...
import com.android.fastcampus.kwave.plot.PayActivity;

public class InicisWebViewClient extends WebViewClient {
	
	private PayActivity activity;
	
	public InicisWebViewClient(PayActivity activity) {
